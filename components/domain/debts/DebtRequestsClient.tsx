...
export default function DebtRequestsClient({ currentUserId }: { currentUserId: string }) {
  ...
  return <div className="page-container debt-page">
    <div className="section-header"><div><div className="debt-back"><Link href="/debts">← Balances &amp; Payments</Link></div><h1 className="debt-title">Debt requests</h1><p className="text-secondary debt-subtitle">Only you and the other participant can see these request details.</p></div><Link className="btn btn-primary" href="/debts/requests/new">Request debt</Link></div>
