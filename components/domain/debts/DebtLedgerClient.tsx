...
export default function DebtLedgerClient({ currentUserId }: { currentUserId: string }) {
  ...
  return <div className="page-container debt-page">
    <div className="section-header"><div><div className="debt-back"><Link href="/debts">← DebtSync</Link></div><h1 className="debt-title">Debt ledger</h1><p className="text-secondary debt-subtitle">Settlement obligations and member-confirmed payments.</p></div><div className="debt-command-grid"><Link href="/debts/payments/new" className="btn btn-primary debt-full-mobile">Record money</Link></div></div>
