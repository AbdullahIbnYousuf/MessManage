  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-950">
      <div className="bg-gray-900 border border-gray-800 rounded-2xl p-12 w-full max-w-md text-center">
        <div className="w-12 h-12 rounded-xl bg-linear-to-br from-cyan-500 to-blue-500 flex items-center justify-center text-white font-bold text-xl mx-auto mb-6">
          M
        </div>
        <h1 className="text-2xl font-bold text-white mb-2">MealSync</h1>
        ...
        <p className="text-gray-600 text-xs mt-6">
          Sign in requires admin approval for new members.
        </p>
      </div>
    </div>
  );
